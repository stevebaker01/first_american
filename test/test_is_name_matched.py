...
class TestIsNameMatchedFull:
    ...
    def test_is_name_matched_match(self, session):
        """
    ...
    def test_is_name_matched_no_match(self, session):
        """
        Singler buyer and single seller no match.
        """
    ...
    def test_is_name_matched_multiple_buyers_one_match(self, session):
        """
    ...
    def test_is_name_matched_multiple_buyers_no_match(self, session):
        """
    ...
    def test_is_name_matched_multiple_owners_one_match(self, session):
        """
        Multiple owners and a single seller match.
        """
    ...
    def test_is_name_matched_multiple_owners_no_match(self, session):
        """
        Multiple owners and a single seller no match.
        """
        buyers = prep_list(["BAKER STEVEN A", "LEE ERIC M", "DAVIDSON DAVID D", "STEVENS STEVEN"])
        owners = prep_list(["Jenner Bruce K"])
        json_data = match_name(buyers=buyers, owners=owners)
    ...
    def test_is_name_matched_multiple_owners_multiple_matches(self, session):
        """
    ...
    def test_is_name_matched_multiple_buyers_multiple_owners_multiple_matches(self, session):
        """
        Multiple buyers and multiple owners with mutiple matches.
        :param session:
        :return:
        """
        buyers = prep_list(["Baker Steven A", "Baker Anne", "Baker Edwin C", "Baker Joanne I", "Cameron James"])
